...
void LeastSquare(){
    ...
    std::cout << std::endl << std::left << std::setw(8) << "Slope:" << std::left << std::setw(13) << reg["Slope"];
    std::cout << std::left << std::setw(16) << "Y-Intercept: " << std::left << std::setw(8) << reg["Y-Intercept"] << std::endl;
    std::cout << std::endl << std::left << std::setw(8) << "Slope Error: " << std::left << std::setw(8) << reg["Slope Error"];
    std::cout << std::left << std::setw(16) <<"Y-Intercept Error: " << std::left << std::setw(8) << reg["Y-Intercept Error"] << std::endl;
    std::cout << std::endl << std::left << std::setw(8) << "0Slope: " << std::left << std::setw(13) << reg["0Slope"];
    std::cout << std::left << std::setw(16) << "0Slope Error: " << std::left << std::setw(8) << reg["0Slope Error"] << std::endl;
